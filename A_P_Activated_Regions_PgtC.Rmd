...
FgtC_P_Activated <- read_excel("M:/Documents/Hariri_review/USE_ME/FgtC_PgtC.xlsx")
colnames(FgtC_P_Activated)[43:45] = c( "FgtC_PgtC", "WB_Th", "ROI_Th")

#FgtC_P_Activated_LONG <- gather(FgtC_P_Activated, Diagnosis, Present, c(6:16,18:28, 30:40) , factor_key=TRUE)
#FgtC_P_Activated <- filter(FgtC_P_Activated_LONG, Present==1)
```


```{r}
#How many samples have which clinical groups
print(paste0("ADHD: ", nrow(subset(FgtC_P_Activated, PG1_ADHD == 1 | PG2_ADHD == 1 |  PG3_ADHD == 1))))
print(paste0("Anxiety Related Disorder: ", nrow(subset(FgtC_P_Activated, PG1_ARD == 1 | PG2_ARD == 1 |  PG3_ARD == 1))))
print(paste0("Autism Spectrum Disorder: ", nrow(subset(FgtC_P_Activated, PG1_ASD == 1 | PG2_ASD == 1 |  PG3_ASD == 1))))
print(paste0("Bipolar Disorder: ", nrow(subset(FgtC_P_Activated, PG1_BP == 1 | PG2_BP == 1 |  PG3_BP == 1))))
print(paste0("Body Dismorphic Disorder: ", nrow(subset(FgtC_P_Activated, PG1_BDD == 1 | PG2_BDD == 1 |  PG3_BDD == 1))))
print(paste0("Borderline Personality Disorder: ", nrow(subset(FgtC_P_Activated, PG1_BPD == 1 | PG2_BPD == 1 |  PG3_BPD == 1))))
print(paste0("Gender Dyshoria: ", nrow(subset(FgtC_P_Activated, PG1_GD == 1 | PG2_GD == 1 |  PG3_GD == 1))))
print(paste0("MDD: ", nrow(subset(FgtC_P_Activated, PG1_MDD == 1 | PG2_MDD == 1 |  PG3_MDD == 1))))
print(paste0("OCD: ", nrow(subset(FgtC_P_Activated, PG1_OCD == 1 | PG2_OCD == 1 |  PG3_OCD == 1))))
print(paste0("Schizophrenia: ", nrow(subset(FgtC_P_Activated, PG1_Schizophrenia == 1 | PG2_Schizophrenia == 1 |  PG3_Schizophrenia == 1))))
print(paste0("SUD: ", nrow(subset(FgtC_P_Activated, PG1_SUD == 1 | PG2_SUD == 1 |  PG3_SUD == 1))))
...
```{r}
if (Diagnosis == 'ADHD') {
  FgtC_P_Activated <- subset(FgtC_P_Activated, PG1_ADHD == 1 | PG2_ADHD == 1 |  PG3_ADHD == 1)
} else if (Diagnosis == 'ARD') {
 FgtC_P_Activated <- subset(FgtC_P_Activated, PG1_ARD == 1 | PG2_ARD == 1 |  PG3_ARD == 1)
} else if (Diagnosis == 'ASD') {
  FgtC_P_Activated <- subset(FgtC_P_Activated, PG1_ASD == 1 | PG2_ASD == 1 |  PG3_ASD == 1)
} else if (Diagnosis == 'BDD') {
FgtC_P_Activated <- subset(FgtC_P_Activated, PG1_BDD == 1 | PG2_BDD == 1 |  PG3_BDD == 1)
} else if (Diagnosis == 'BP') {
  FgtC_P_Activated <- subset(FgtC_P_Activated, PG1_BP == 1 | PG2_BP == 1 |  PG3_BP == 1)
} else if (Diagnosis == 'BPD') {
  FgtC_P_Activated <- subset(FgtC_P_Activated, PG1_BPD == 1 | PG2_BPD == 1 |  PG3_BPD == 1)
} else if (Diagnosis == 'GD') {
  FgtC_P_Activated <- subset(FgtC_P_Activated, PG1_GD == 1 | PG2_GD == 1 |  PG3_GD == 1)
} else if (Diagnosis == 'MDD') {
  FgtC_P_Activated <- subset(FgtC_P_Activated, PG1_MDD == 1 | PG2_MDD == 1 |  PG3_MDD == 1)
} else if (Diagnosis == 'OCD') {
  FgtC_P_Activated <- subset(FgtC_P_Activated, PG1_OCD == 1 | PG2_OCD == 1 |  PG3_OCD == 1)
} else if (Diagnosis == 'Schizophrenia') {
  FgtC_P_Activated <- subset(FgtC_P_Activated, PG1_Schizophrenia == 1 | PG2_Schizophrenia == 1 |  PG3_Schizophrenia == 1)
} else if (Diagnosis == 'SUD') {
  FgtC_P_Activated <- subset(FgtC_P_Activated, PG1_SUD == 1 | PG2_SUD == 1 |  PG3_SUD == 1)
}
...
#Select the columns that will be used
```{r}
FgtC_P_Activated <- select(FgtC_P_Activated, c('Article_Num','Publication_Year',
                              "ROI_regions",
                              "FgtC_PgtC",
                              "WB_Th",
                              "ROI_Th"))

colnames(FgtC_P_Activated) <- c("Article_Num", "Publication_Year", "ROI_regions", "FgtC_PgtC", "WB_Th", "ROI_Th")
```
...
```{r}
FgtC_P_Activated[FgtC_P_Activated == "NA"] <- NA
FgtC_P_Activated <- FgtC_P_Activated %>%
...
FgtC_P_Activated$ROI_regions <- tolower(FgtC_P_Activated$ROI_regions)
FgtC_P_Activated$FgtC_PgtC <- tolower(FgtC_P_Activated$FgtC_PgtC)

#Select the rows that will be used (only ones with patient groups)
#FgtC_P_Activated <- filter(FgtC_P_Activated, !is.na(PG1_Diagnosis_stand))

```


```{r}
#Create empty vector to store the total number of contrasts using each threshold: 
Th_Counts <- vector(mode = "numeric", length = 9)
```
...
FgtC_P_Specified_ROI1 <- filter(FgtC_P_Activated, ROI_Th ==  1)
Th1_ID <- FgtC_P_Specified_ROI1[,c("Article_Num", "Publication_Year")]
Th_Counts[1] <- nrow(Th1_ID)

###GET ROIs THAT STUDIES SPECIFIED:
#make columns based on the ROIs specified
FgtC_P_Specified_ROI1 <- separate(FgtC_P_Specified_ROI1, c(ROI_regions), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10"), sep = ',')

#make into long format
Headings <- melt(FgtC_P_Specified_ROI1[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10")], id.vars=c('Article_Num','Publication_Year'), var='ROI_specified')
...
FgtC_P_Activated_ROI1 <- filter(FgtC_P_Activated, ROI_Th ==  1)
FgtC_P_Activated_ROI1 <- separate(FgtC_P_Activated_ROI1, c(FgtC_PgtC), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10", 
...
FgtC_P_Activated_ROI1 <- FgtC_P_Activated_ROI1 %>% mutate(across(where(is.character), str_trim))
...
FgtC_P_Specified_ROI1 <- select(FgtC_P_Specified_ROI1, -c(Article_Num, Publication_Year, FgtC_PgtC, WB_Th, ROI_Th))
FgtC_P_Activated_ROI1 <- select(FgtC_P_Activated_ROI1, -c(Article_Num, Publication_Year, ROI_regions, WB_Th, ROI_Th))

GroupList = ROI_list

#Create empty dataframe to store the counts
Counts_ROI_Th1 <- data.frame(matrix(ncol = length(ROI_list), nrow = nrow(FgtC_P_Activated_ROI1)))
Searched_ROI_Th1 <- data.frame(matrix(ncol = length(ROI_list), nrow = nrow(FgtC_P_Activated_ROI1)))
...
for (n in 1:nrow(FgtC_P_Activated_ROI1)){       #for each row of the ROI_1 df
  #print(as.integer(n)) 
  ColList <- names(FgtC_P_Specified_ROI1)[!is.na(FgtC_P_Specified_ROI1[n,])] #only select the ROIs that they said they were interested in
  ROIs_Specified <- as.character(FgtC_P_Specified_ROI1[n, ColList])
      ...
      #print(group)
       if (grepl(GroupList[which(GroupList == group)], c)) { #If they searched for it, add a 1 to the the column in the df
         ...
         Searched_ROI_Th1[n,group] <- (1)
          ...
          if (sum(grepl(GroupList[which(GroupList == group)], FgtC_P_Activated_ROI1[n,AllActivatedCols])) >= 1){ #if they reported it was active, add a 1 to the column in the df
...
FgtC_P_Specified_ROI2 <- filter(FgtC_P_Activated, ROI_Th ==  2)
Th2_ID <- FgtC_P_Specified_ROI2[,c("Article_Num", "Publication_Year")]
Th_Counts[2] <- nrow(Th2_ID)

###GET ROIs THAT STUDIES SPECIFIED:
#make columns based on the ROIs specified
FgtC_P_Specified_ROI2 <- separate(FgtC_P_Specified_ROI2, c(ROI_regions), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10","Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30"), sep = ',')

#make into long format
Headings <- melt(FgtC_P_Specified_ROI2[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10",
                                        "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20",
                                        "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30")], 
...
```{r}
###GET ROIs THAT STUDIES REPORTED AS ACTIVATED:
FgtC_P_Activated_ROI2 <- filter(FgtC_P_Activated, ROI_Th ==  2)
FgtC_P_Activated_ROI2 <- separate(FgtC_P_Activated_ROI2, c(FgtC_PgtC), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10", 
                                                                         "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                          "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30"), sep = ',')
FgtC_P_Activated_ROI2 <- FgtC_P_Activated_ROI2 %>% mutate(across(where(is.character), str_trim))

```
#Th2: Code if an ROI was selected (Searched_ROI_Th1) and if it was reported as activated (Counts_ROI_Th1)
```{r}
#Remove extra columns from Specified + Activated
FgtC_P_Specified_ROI2 <- select(FgtC_P_Specified_ROI2, -c(Article_Num, Publication_Year, FgtC_PgtC, WB_Th, ROI_Th))
FgtC_P_Activated_ROI2 <- select(FgtC_P_Activated_ROI2, -c(Article_Num, Publication_Year, ROI_regions, WB_Th, ROI_Th))

GroupList = ROI_list

#Create empty dataframe to store the counts
Counts_ROI_Th2 <- data.frame(matrix(ncol = length(ROI_list), nrow = nrow(FgtC_P_Activated_ROI2)))
Searched_ROI_Th2 <- data.frame(matrix(ncol = length(ROI_list), nrow = nrow(FgtC_P_Activated_ROI2)))
...
for (n in 1:nrow(FgtC_P_Specified_ROI2)){       #for each row of the ROI_1 df
  #print(as.integer(n)) 
  ColList <- names(FgtC_P_Specified_ROI2)[!is.na(FgtC_P_Specified_ROI2[n,])] #only select the ROIs that they said they were interested in
  ROIs_Specified <- as.character(FgtC_P_Specified_ROI2[n, ColList])
      ...
      #print(group)
       if (grepl(GroupList[which(GroupList == group)], c)) { #If they searched for it, add a 1 to the the column in the df
         ...
         Searched_ROI_Th2[n,group] <- (1)
          ...
          if (sum(grepl(GroupList[which(GroupList == group)], FgtC_P_Activated_ROI2[n,AllActivatedCols])) >= 1){ #if they reported it was active, add a 1 to the column in the df
...
FgtC_P_Specified_ROI3 <- filter(FgtC_P_Activated, ROI_Th == 3)
Th3_ID <- FgtC_P_Specified_ROI3[,c("Article_Num", "Publication_Year")]
Th_Counts[3] <- nrow(Th3_ID)

###GET ROIs THAT STUDIES SPECIFIED:
#make columns based on the ROIs specified
FgtC_P_Specified_ROI3 <- separate(FgtC_P_Specified_ROI3, c(ROI_regions), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10","Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30"), sep = ',')

#make into long format
Headings <- melt(FgtC_P_Specified_ROI3[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10",
                                        "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                        "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30")],
                 id.vars=c('Article_Num','Publication_Year'), var='ROI_specified')
...
```{r}
###GET ROIs THAT STUDIES REPORTED AS ACTIVATED:
FgtC_P_Activated_ROI3 <- filter(FgtC_P_Activated, ROI_Th ==  3)
FgtC_P_Activated_ROI3 <- separate(FgtC_P_Activated_ROI3, c(FgtC_PgtC), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10", 
                                                                         "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                          "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30", 
                                                                         "Region31",  "Region32", "Region33", "Region34", "Region35", "Region36", "Region37", "Region38", "Region39", "Region40", 
                                                                         "Region41",  "Region42", "Region43", "Region44", "Region45"), sep = ',')
FgtC_P_Activated_ROI3 <- FgtC_P_Activated_ROI3 %>% mutate(across(where(is.character), str_trim))
...
```{r}
#Remove extra columns from Specified + Activated
FgtC_P_Specified_ROI3 <- select(FgtC_P_Specified_ROI3, -c(Article_Num, Publication_Year, FgtC_PgtC, WB_Th, ROI_Th))
FgtC_P_Activated_ROI3 <- select(FgtC_P_Activated_ROI3, -c(Article_Num, Publication_Year, ROI_regions, WB_Th, ROI_Th))

GroupList = ROI_list

#Create empty dataframe to store the counts
Counts_ROI_Th3 <- data.frame(matrix(ncol = length(ROI_list), nrow = nrow(FgtC_P_Activated_ROI3)))
Searched_ROI_Th3 <- data.frame(matrix(ncol = length(ROI_list), nrow = nrow(FgtC_P_Activated_ROI3)))
...
for (n in 1:nrow(FgtC_P_Specified_ROI3)){       #for each row of the ROI_1 df
  #print(as.integer(n)) 
  ColList <- names(FgtC_P_Specified_ROI3)[!is.na(FgtC_P_Specified_ROI3[n,])] #only select the ROIs that they said they were interested in
  ROIs_Specified <- as.character(FgtC_P_Specified_ROI3[n, ColList])
      ...
      #print(group)
       if (grepl(GroupList[which(GroupList == group)], c)) { #If they searched for it, add a 1 to the the column in the df
         ...
         Searched_ROI_Th3[n,group] <- (1)
          ...
          if (sum(grepl(GroupList[which(GroupList == group)], FgtC_P_Activated_ROI3[n,AllActivatedCols])) >= 1){ #if they reported it was active, add a 1 to the column in the df
...
FgtC_P_Specified_ROI4 <- filter(FgtC_P_Activated, ROI_Th == 4)
Th4_ID <- FgtC_P_Specified_ROI4[,c("Article_Num", "Publication_Year")]
Th_Counts[4] <- nrow(Th4_ID)

###GET ROIs THAT STUDIES SPECIFIED:
#make columns based on the ROIs specified
FgtC_P_Specified_ROI4 <- separate(FgtC_P_Specified_ROI4, c(ROI_regions), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10",
                                                                              "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                              "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30"), sep = ',')

#make into long format
Headings <- melt(FgtC_P_Specified_ROI4[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10",
                                                                              "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                              "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30")],
                 id.vars=c('Article_Num','Publication_Year'), var='ROI_specified')
...
```{r}
###GET ROIs THAT STUDIES REPORTED AS ACTIVATED:
FgtC_P_Activated_ROI4 <- filter(FgtC_P_Activated, ROI_Th ==  4)
FgtC_P_Activated_ROI4 <- separate(FgtC_P_Activated_ROI4, c(FgtC_PgtC), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10", 
                                                                         "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                          "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30", 
                                                                         "Region31",  "Region32", "Region33", "Region34", "Region35", "Region36", "Region37", "Region38", "Region39", "Region40"), sep = ',')
FgtC_P_Activated_ROI4 <- FgtC_P_Activated_ROI4 %>% mutate(across(where(is.character), str_trim))
...
```{r}
#Remove extra columns from Specified + Activated
FgtC_P_Specified_ROI4 <- select(FgtC_P_Specified_ROI4, -c(Article_Num, Publication_Year, FgtC_PgtC, WB_Th, ROI_Th))
FgtC_P_Activated_ROI4 <- select(FgtC_P_Activated_ROI4, -c(Article_Num, Publication_Year, ROI_regions, WB_Th, ROI_Th))

GroupList = ROI_list

#Create empty dataframe to store the counts
Counts_ROI_Th4 <- data.frame(matrix(ncol = length(ROI_list), nrow = nrow(FgtC_P_Activated_ROI4)))
Searched_ROI_Th4 <- data.frame(matrix(ncol = length(ROI_list), nrow = nrow(FgtC_P_Activated_ROI4)))
...
for (n in 1:nrow(FgtC_P_Specified_ROI4)){       #for each row of the ROI_1 df
  #print(as.integer(n)) 
  ColList <- names(FgtC_P_Specified_ROI4)[!is.na(FgtC_P_Specified_ROI4[n,])] #only select the ROIs that they said they were interested in
  ROIs_Specified <- as.character(FgtC_P_Specified_ROI4[n, ColList])
      ...
      #print(group)
       if (grepl(GroupList[which(GroupList == group)], c)) { #If they searched for it, add a 1 to the the column in the df
         ...
         Searched_ROI_Th4[n,group] <- (1)
          ...
          if (sum(grepl(GroupList[which(GroupList == group)], FgtC_P_Activated_ROI4[n,AllActivatedCols])) >= 1){ #if they reported it was active, add a 1 to the column in the df
...
FgtC_P_Specified_ROI5 <- filter(FgtC_P_Activated, WB_Th == 5)
Th5_ID <- FgtC_P_Specified_ROI5[,c("Article_Num", "Publication_Year")]
Th_Counts[5] <- nrow(Th5_ID)

###GET ROIs THAT STUDIES SPECIFIED:
#make columns based on the ROIs specified
FgtC_P_Specified_ROI5 <- separate(FgtC_P_Specified_ROI5, c(ROI_regions), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10","Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30"), sep = ',')

#make into long format
Headings <- melt(FgtC_P_Specified_ROI5[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10",
                                        "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                        "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30")], 
                id.vars=c('Article_Num','Publication_Year'), var='ROI_specified')
...
```{r}
###GET ROIs THAT STUDIES REPORTED AS ACTIVATED:
FgtC_P_Activated_ROI5 <- filter(FgtC_P_Activated, WB_Th ==  5)
FgtC_P_Activated_ROI5 <- separate(FgtC_P_Activated_ROI5, c(FgtC_PgtC), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10", 
                                                                         "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                          "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30", 
                                                                         "Region31",  "Region32", "Region33", "Region34", "Region35", "Region36", "Region37", "Region38", "Region39", "Region40", 
                                                                          "Region41",  "Region42", "Region43", "Region44", "Region45"), sep = ',')
FgtC_P_Activated_ROI5 <- FgtC_P_Activated_ROI5 %>% mutate(across(where(is.character), str_trim))


#make into long format
Headings_Active <- melt(FgtC_P_Activated_ROI5[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10", 
                                                                          "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                          "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30", 
                                                                         "Region31",  "Region32", "Region33", "Region34", "Region35", "Region36", "Region37", "Region38", "Region39", "Region40", 
                                                                          "Region41",  "Region42", "Region43", "Region44", "Region45")], id.vars=c('Article_Num','Publication_Year'), var='ROI_specified')
...
```{r}
#Remove extra columns from Specified + Activated
FgtC_P_Specified_ROI5 <- select(FgtC_P_Specified_ROI5, -c(Article_Num, Publication_Year, FgtC_PgtC, WB_Th, ROI_Th))
FgtC_P_Activated_ROI5 <- select(FgtC_P_Activated_ROI5, -c(Article_Num, Publication_Year, ROI_regions, WB_Th, ROI_Th))

GroupList = Active_List #Instead of searching within the Regions that were 

#Create empty data frame to store the counts
Counts_ROI_Th5 <- data.frame(matrix(ncol = length(Active_List), nrow = nrow(FgtC_P_Activated_ROI5)))
...
for (n in 1:nrow(FgtC_P_Activated_ROI5)){       #for each row of the Activated df
  #print(as.integer(n)) 
  ColList <- names(FgtC_P_Activated_ROI5)[!is.na(FgtC_P_Activated_ROI5[n,])] #only select the Activated columns that have
      ...
      #print(group)
       ...
       if (grepl(GroupList[which(GroupList == group)], FgtC_P_Activated_ROI5[n,c])) { #If they said it was activated add a 1 to the the column in the df
         #print(group)
         Counts_ROI_Th5[n,group] <- (1)
         
          #if (sum(grepl(GroupList[which(GroupList == group)], FgtC_P_Activated_ROI5[n,AllActivatedCols])) >= 1){ #if they reported it was active, add a 1 to the column in the df
          #  Counts_ROI_Th5[n,group] <- (1)}
...
Th5[1,] <- nrow(FgtC_P_Specified_ROI5)
...
FgtC_P_Specified_ROI6 <- filter(FgtC_P_Activated, WB_Th == 6)
Th6_ID <- FgtC_P_Specified_ROI6[,c("Article_Num", "Publication_Year")]
Th_Counts[6] <- nrow(Th6_ID)

###GET ROIs THAT STUDIES SPECIFIED:
#make columns based on the ROIs specified
FgtC_P_Specified_ROI6 <- separate(FgtC_P_Specified_ROI6, c(ROI_regions), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10","Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30"), sep = ',')

#make into long format
Headings <- melt(FgtC_P_Specified_ROI6[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10",
                                        "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                        "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30")], 
                id.vars=c('Article_Num','Publication_Year'), var='ROI_specified')
...
```{r}
###GET ROIs THAT STUDIES REPORTED AS ACTIVATED:
FgtC_P_Activated_ROI6 <- filter(FgtC_P_Activated, WB_Th ==  6)
FgtC_P_Activated_ROI6 <- separate(FgtC_P_Activated_ROI6, c(FgtC_PgtC), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10", 
                                                                         "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                          "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30", 
                                                                         "Region31",  "Region32", "Region33", "Region34", "Region35", "Region36", "Region37", "Region38", "Region39", "Region40"), sep = ',')
FgtC_P_Activated_ROI6 <- FgtC_P_Activated_ROI6 %>% mutate(across(where(is.character), str_trim))


#make into long format
Headings_Active <- melt(FgtC_P_Activated_ROI6[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10",
                                                                        "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                          "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30", 
...
```{r}
#Remove extra columns from Specified + Activated
FgtC_P_Specified_ROI6 <- select(FgtC_P_Specified_ROI6, -c(Article_Num, Publication_Year, FgtC_PgtC, WB_Th, ROI_Th))
FgtC_P_Activated_ROI6 <- select(FgtC_P_Activated_ROI6, -c(Article_Num, Publication_Year, ROI_regions, WB_Th, ROI_Th))

GroupList = ROI_list
GroupList = Active_List #Instead of searching within the Regions that were 

#Create empty data frame to store the counts
Counts_ROI_Th6 <- data.frame(matrix(ncol = length(Active_List), nrow = nrow(FgtC_P_Activated_ROI6)))
...
for (n in 1:nrow(FgtC_P_Activated_ROI6)){       #for each row of the Activated df
  #print(as.integer(n)) 
  ColList <- names(FgtC_P_Activated_ROI6)[!is.na(FgtC_P_Activated_ROI6[n,])] #only select the Activated columns that have
      ...
      #print(group)
       ...
       if (grepl(GroupList[which(GroupList == group)], FgtC_P_Activated_ROI6[n,c])) { #If they said it was activated add a 1 to the the column in the df
         #print(group)
...
Th6[1,] <- nrow(FgtC_P_Specified_ROI6)
...
```{r}
#ROI Threshold 5: WHOLE BRAIN --> Uncorrected
FgtC_P_Specified_ROI7 <- filter(FgtC_P_Activated, WB_Th == 7)
Th7_ID <- FgtC_P_Specified_ROI7[,c("Article_Num", "Publication_Year")]
Th_Counts[7] <- nrow(Th7_ID)

###GET ROIs THAT STUDIES SPECIFIED:
#make columns based on the ROIs specified
FgtC_P_Specified_ROI7 <- separate(FgtC_P_Specified_ROI7, c(ROI_regions), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10","Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30"), sep = ',')

#make into long format
Headings <- melt(FgtC_P_Specified_ROI7[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10",
                                        "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                        "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30")], 
                id.vars=c('Article_Num','Publication_Year'), var='ROI_specified')
...
```{r}
###GET ROIs THAT STUDIES REPORTED AS ACTIVATED:
FgtC_P_Activated_ROI7 <- filter(FgtC_P_Activated, WB_Th ==  7)
FgtC_P_Activated_ROI7 <- separate(FgtC_P_Activated_ROI7, c(FgtC_PgtC), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10", 
                                                                         "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                          "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30", 
                                                                         "Region31",  "Region32", "Region33", "Region34", "Region35", "Region36", "Region37", "Region38", "Region39", "Region40"), sep = ',')
FgtC_P_Activated_ROI7 <- FgtC_P_Activated_ROI7 %>% mutate(across(where(is.character), str_trim))


#make into long format
Headings_Active <- melt(FgtC_P_Activated_ROI7[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10", 
                                                                         "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                          "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30", 
                                                                         "Region31",  "Region32", "Region33", "Region34", "Region35", "Region36", "Region37", "Region38", "Region39", "Region40")], id.vars=c('Article_Num','Publication_Year'), var='ROI_specified')
...
```{r}
#Remove extra columns from Specified + Activated
FgtC_P_Specified_ROI7 <- select(FgtC_P_Specified_ROI7, -c(Article_Num, Publication_Year, FgtC_PgtC, WB_Th, ROI_Th))
FgtC_P_Activated_ROI7 <- select(FgtC_P_Activated_ROI7, -c(Article_Num, Publication_Year, ROI_regions, WB_Th, ROI_Th))

GroupList = ROI_list
GroupList = Active_List #Instead of searching within the Regions that were 

#Create empty data frame to store the counts
Counts_ROI_Th7 <- data.frame(matrix(ncol = length(Active_List), nrow = nrow(FgtC_P_Activated_ROI7)))
...
for (n in 1:nrow(FgtC_P_Activated_ROI7)){       #for each row of the Activated df
  #print(as.integer(n)) 
  ColList <- names(FgtC_P_Activated_ROI7)[!is.na(FgtC_P_Activated_ROI7[n,])] #only select the Activated columns that have
      ...
      #print(group)
       ...
       if (grepl(GroupList[which(GroupList == group)], FgtC_P_Activated_ROI7[n,c])) { #If they said it was activated add a 1 to the the column in the df
         #print(group)
...
Th7[1,] <- nrow(FgtC_P_Specified_ROI7)
...
```{r}
#ROI Threshold 5: WHOLE BRAIN --> Uncorrected
FgtC_P_Specified_ROI8 <- filter(FgtC_P_Activated, WB_Th == 8)
Th8_ID <- FgtC_P_Specified_ROI8[,c("Article_Num", "Publication_Year")]
Th_Counts[8] <- nrow(Th8_ID)

###GET ROIs THAT STUDIES SPECIFIED:
#make columns based on the ROIs specified
FgtC_P_Specified_ROI8 <- separate(FgtC_P_Specified_ROI8, c(ROI_regions), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10","Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30"), sep = ',')

#make into long format
Headings <- melt(FgtC_P_Specified_ROI8[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10",
                                        "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                        "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30")], 
                id.vars=c('Article_Num','Publication_Year'), var='ROI_specified')
...
```{r}
###GET ROIs THAT STUDIES REPORTED AS ACTIVATED:
FgtC_P_Activated_ROI8 <- filter(FgtC_P_Activated, WB_Th ==  8)
FgtC_P_Activated_ROI8 <- separate(FgtC_P_Activated_ROI8, c(FgtC_PgtC), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10", 
                                                                         "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                          "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30", 
                                                                         "Region31",  "Region32", "Region33", "Region34", "Region35", "Region36", "Region37", "Region38", "Region39", "Region40"), sep = ',')
FgtC_P_Activated_ROI8 <- FgtC_P_Activated_ROI8 %>% mutate(across(where(is.character), str_trim))


#make into long format
Headings_Active <- melt(FgtC_P_Activated_ROI8[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10", 
                                                                         "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                          "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30", 
                                                                         "Region31",  "Region32", "Region33", "Region34", "Region35", "Region36", "Region37", "Region38", "Region39", "Region40")], id.vars=c('Article_Num','Publication_Year'), var='ROI_specified')
...
```{r}
#Remove extra columns from Specified + Activated
FgtC_P_Specified_ROI8 <- select(FgtC_P_Specified_ROI8, -c(Article_Num, Publication_Year, FgtC_PgtC, WB_Th, ROI_Th))
FgtC_P_Activated_ROI8 <- select(FgtC_P_Activated_ROI8, -c(Article_Num, Publication_Year, ROI_regions, WB_Th, ROI_Th))

GroupList = ROI_list
GroupList = Active_List #Instead of searching within the Regions that were 

#Create empty data frame to store the counts
Counts_ROI_Th8 <- data.frame(matrix(ncol = length(Active_List), nrow = nrow(FgtC_P_Activated_ROI8)))
...
for (n in 1:nrow(FgtC_P_Activated_ROI8)){       #for each row of the Activated df
  #print(as.integer(n)) 
  ColList <- names(FgtC_P_Activated_ROI8)[!is.na(FgtC_P_Activated_ROI8[n,])] #only select the Activated columns that have
      ...
      #print(group)
       ...
       if (grepl(GroupList[which(GroupList == group)], FgtC_P_Activated_ROI8[n,c])) { #If they said it was activated add a 1 to the the column in the df
         #print(group)
...
Th8[1,] <- nrow(FgtC_P_Activated_ROI8)
...
FgtC_P_Specified_ROI9 <- filter(FgtC_P_Activated, WB_Th == 9)
Th9_ID <- FgtC_P_Specified_ROI9[,c("Article_Num", "Publication_Year")]
Th_Counts[9] <- nrow(Th9_ID)

###GET ROIs THAT STUDIES SPECIFIED:
#make columns based on the ROIs specified
FgtC_P_Specified_ROI9 <- separate(FgtC_P_Specified_ROI9, c(ROI_regions), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10","Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30"), sep = ',')

#make into long format
Headings <- melt(FgtC_P_Specified_ROI9[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10",
                                        "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                        "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30")], 
                 id.vars=c('Article_Num','Publication_Year'), var='ROI_specified')
...
```{r}
###GET ROIs THAT STUDIES REPORTED AS ACTIVATED:
FgtC_P_Activated_ROI9 <- filter(FgtC_P_Activated, WB_Th == 9)
FgtC_P_Activated_ROI9 <- separate(FgtC_P_Activated_ROI9, c(FgtC_PgtC), into = c("Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10", 
                                                                         "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                                                         "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30", 
                                                                         "Region31",  "Region32", "Region33", "Region34", "Region35", "Region36", "Region37", "Region38", "Region39", "Region40"), sep = ',')
FgtC_P_Activated_ROI9 <- FgtC_P_Activated_ROI9 %>% mutate(across(where(is.character), str_trim))


#make into long format
Headings_Active <- melt(FgtC_P_Activated_ROI9[,c('Article_Num','Publication_Year',"Region1", "Region2", "Region3", "Region4", "Region5", "Region6", "Region7", "Region8", "Region9", "Region10", 
                                               "Region11", "Region12", "Region13", "Region14", "Region15", "Region16", "Region17", "Region18", "Region19", "Region20", 
                                               "Region21", "Region22", "Region23", "Region24", "Region25", "Region26", "Region27", "Region28", "Region29", "Region30", 
                                               "Region31",  "Region32", "Region33", "Region34", "Region35", "Region36", "Region37", "Region38", "Region39", "Region40")], id.vars=c('Article_Num','Publication_Year'), var='ROI_specified')
...
```{r}
#Remove extra columns from Specified + Activated
FgtC_P_Specified_ROI9 <- select(FgtC_P_Specified_ROI9, -c(Article_Num, Publication_Year, FgtC_PgtC, WB_Th, ROI_Th))
FgtC_P_Activated_ROI9 <- select(FgtC_P_Activated_ROI9, -c(Article_Num, Publication_Year, ROI_regions, WB_Th, ROI_Th))

GroupList = ROI_list
GroupList = Active_List #Instead of searching within the Regions that were 

#Create empty data frame to store the counts
Counts_ROI_Th9 <- data.frame(matrix(ncol = length(Active_List), nrow = nrow(FgtC_P_Activated_ROI9)))
...
for (n in 1:nrow(FgtC_P_Activated_ROI9)){       #for each row of the Activated df
  #print(as.integer(n)) 
  ColList <- names(FgtC_P_Activated_ROI9)[!is.na(FgtC_P_Activated_ROI9[n,])] #only select the Activated columns that have
  ...
  for (c in ColList){                         #for the ROIs that they said they were interested in
    ...
    for (group in GroupList){                       #find the string match (column names based on all ROIs mentioned)
      ...
      if (grepl(GroupList[which(GroupList == group)], FgtC_P_Activated_ROI9[n,c])) { #If they said it was activated add a 1 to the the column in the df
        #print(group)
...
Th9[1,] <- nrow(FgtC_P_Activated_ROI9)
...
write.table(Th_Counts, file = paste0("M:/Documents/Hariri_review/USE_ME/Activations/Patients/Th_Counts_", Diagnosis ,".txt"), col.names = FALSE)
...
write.csv(Total_counts, paste0("M:/Documents/Hariri_review/USE_ME/Activations/Patients/Total_Counts_",Diagnosis,".csv"), row.names=TRUE)
```
...
```{r}
REGIONS <- (setdiff(ls(), c("Total_counts", "REGIONS","r", "df","df2", "df2L", "df2R", "Regions_Activated", "Regions_Activated_L", "Regions_Activated_R")))
...
write.csv(Regions_Activated, paste0("M:/Documents/Hariri_review/USE_ME/Activations/Patients/Regions_Activated_OCD.csv"), row.names=TRUE)
